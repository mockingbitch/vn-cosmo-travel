...
<div>
    ...
    <select
        ...
        required
    >
        <option value="" disabled @selected(! old('region', $destination?->region))>{{ __('Select region') }}</option>
...
<div>
    <label class="block text-sm font-medium text-slate-700">{{ __('Name (VI)') }}</label>
    <input
        name="name_vi"
