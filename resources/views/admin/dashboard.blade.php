    ...
    <div class="grid gap-8">
        ...
        <div class="grid gap-4 sm:grid-cols-3">
            <div class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm ring-1 ring-slate-100">
                ...
                <div class="text-xs font-semibold uppercase tracking-wide text-slate-500">{{ __('ui.total_posts') }}</div>
            ...
            <div class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm ring-1 ring-slate-100">
                ...
                <div class="text-xs font-semibold uppercase tracking-wide text-slate-500">{{ __('ui.total_tours') }}</div>
            ...
            <div class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm ring-1 ring-slate-100">
                ...
                <div class="text-xs font-semibold uppercase tracking-wide text-slate-500">{{ __('ui.total_bookings_2') }}</div>
        ...
        <div class="grid gap-6 lg:grid-cols-3">
                    ...
                    <div class="overflow-hidden rounded-2xl border border-slate-200">
                        <table class="min-w-full divide-y divide-slate-200 text-sm">
                            ...
                            <tbody class="divide-y divide-slate-200 bg-white">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-4 py-12 text-center text-slate-500">{{ __('ui.no_posts_yet') }}</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
            ...
            <div>
                <x-admin.card :title="__('ui.quick_actions')" :subtitle="__('ui.shortcuts_to_common_tasks')">
